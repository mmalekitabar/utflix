...
$(BUILD_DIR)/handlers.o: handlers.cpp handlers.hpp UsersRepository.h server/server.hpp utils/utilities.hpp utils/response.hpp utils/request.hpp utils/include.hpp
